...
import {
  ...
  HeartPulse, AlertTriangle, Pill, ChevronDown, Phone, Mail,
  CheckCircle2, ArrowRight, Eye, Clock,
} from "lucide-react";
        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-6 py-20 md:grid-cols-2 md:items-center md:py-28">
          <div className="fade-up">
            ...
            <h1 className="mt-6 text-5xl font-bold leading-tight text-foreground md:text-6xl lg:text-7xl">
              Monitoreo inteligente para<br />
              <span className="bg-[image:var(--gradient-primary)] bg-clip-text text-transparent">
                adultos mayores.
              </span>
            </h1>
            <p className="mt-6 text-xl text-muted-foreground md:text-2xl">
              Un reloj inteligente que detecta caídas, monitorea signos vitales
              y alerta automáticamente a familiares y cuidadores.
            ...
            <div className="mt-10 flex flex-col gap-4 sm:flex-row">
              ...
              <a href="#funciona" className="inline-flex h-14 items-center justify-center rounded-2xl border-2 border-border bg-card px-8 text-lg font-semibold text-foreground transition hover:border-primary">
                Cómo funciona
              </a>
            </div>
  ...
  <div>
    ...
    <p className="text-sm text-muted-foreground">
      Tiempo de alerta
              ...
              <span className="flex items-center gap-2"><CheckCircle2 className="h-5 w-5 text-success" /> Fácil de usar</span>
              <span className="flex items-center gap-2"><CheckCircle2 className="h-5 w-5 text-success" /> Alertas inmediatas</span>
              <span className="flex items-center gap-2"><CheckCircle2 className="h-5 w-5 text-success" /> Diseñado para mayores</span>
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <div className="overflow-hidden rounded-[2rem] bg-card shadow-[var(--shadow-medium)] ring-1 ring-border">
              <img src={heroImg} alt="Reloj VitalWatch monitoreando los signos vitales de un adulto mayor" className="aspect-[5/4] w-full object-cover" />
            </div>
            {/* Floating cards */}
            <div className="absolute -left-4 top-12 hidden rounded-2xl bg-card/95 p-4 shadow-[var(--shadow-medium)] ring-1 ring-border backdrop-blur md:flex md:items-center md:gap-3">
              ...
              <div>
                ...
                <p className="text-xl font-bold">76 <span className="text-sm font-normal">bpm</span></p>
              </div>
            </div>
            <div className="absolute -bottom-4 -right-4 hidden rounded-2xl bg-card/95 p-4 shadow-[var(--shadow-medium)] ring-1 ring-border backdrop-blur md:flex md:items-center md:gap-3">
              ...
              <div>
                ...
                <p className="text-xl font-bold">98<span className="text-sm font-normal">%</span></p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              <div key={title} className="rounded-2xl bg-card p-6 shadow-[var(--shadow-soft)] ring-1 ring-border">
  ...
  <div className="grid gap-12 md:grid-cols-2 items-center">
    <div>
      <ul className="space-y-4 text-lg">
        <li>✅ Frecuencia cardíaca en vivo</li>
    ...
    <div className="flex justify-center">
      <div className="w-72 h-[580px] rounded-[40px] bg-card border border-border shadow-[var(--shadow-medium)] flex items-center justify-center">
        <p className="text-muted-foreground">
          Mockup App VitalWatch
        </p>
      </div>
    </div>
  </div>
      ...
      {/* BENEFICIOS */}
      <section id="beneficios" className="bg-muted/40 py-20 md:py-28">
        <div className="mx-auto max-w-7xl px-6">
          ...
          <div className="grid items-center gap-12 md:grid-cols-2">
            <div className="space-y-5">
              {[
                ...
                <div key={a.title} className="flex items-center gap-4 rounded-2xl bg-card p-5 shadow-[var(--shadow-soft)] ring-1 ring-border">
                  <div className={`grid h-12 w-12 place-items-center rounded-xl bg-${a.color}/10 text-${a.color}`}>
            ...
            <div>
              ...
              <p className="mt-4 text-lg text-muted-foreground">
                Cada evento se envía por WiFi a los contactos configurados con la información esencial: tipo de alerta, hora y ubicación aproximada.
              </p>
